...
WooCommerceAPI.prototype._request = async function(method, endpoint, newData) {
  ...
  params.qs.userRole = await AsyncStorage.getItem('userRole');
  params.qs.currentLanguage = await AsyncStorage.getItem('currentLanguage');
  // params.qs.userID = await AsyncStorage.getItem('userId');
